...
const Screen2: React.FC = () => {
  ...
  // const [value2, setValue2] = useState<string>('≈2.04459305');
  // const [currency, setCurrency] = useState<string>('BTC');
  // const [currency2, setCurrency2] = useState<string>('ETH');
  // const [src1, setSrc1] = useState<string>(logo);
  // const [src2, setSrc2] = useState<string>(etc);
  const src1: string = logo;
  const src2: string = etc;
  const currency2: string = 'ETH';
  const value2: string = '≈2.04459305';
    ...
    <>
      ...
      <div>
        <div className='flex justify-center items-center'>
          <h1 className='text-black font-semibold text-xl'>Add Exchange Details</h1>
        </div>
