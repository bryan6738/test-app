    ...
    <div className='p-1 bg-regal-blue'>
      <div className='bg-white rounded-3xl drop-shadow-xl'>
        ...
        <div className='w-full flex cursor-pointer'>
          ...
          <div
            className={`w-1/2 ${
              !isActive ? `${roundedTrClass} ${roundedBrClass}` : ''
            } text-[11px] rounded-tl-3xl p-3 text-black/60 flex justify-center items-center border-2`}
            onClick={handleClick}
          >
          ...
          <div
            className={`w-1/2 p-3 rounded-tr-3xl text-[11px] text-black/60 border-2 flex justify-center items-center ${
