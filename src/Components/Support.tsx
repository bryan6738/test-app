    ...
    return (
        <>
            <div className='mx-1 mt-5 bg-[#062763] border rounded-lg'>
                {/* making the img and privacy flex */}
                <div className='flex justify-between mx-2'>
                    <div className='ml-[2%] mt-[5%]'>
                        <p className='text-[#337bb6] text-sm font-semibold'>24/7 support</p>
                    </div>
                    <div className='pt-2'>
                        <img src={hf} alt="" width={120} className='-mb-9' />
                    </div>
                </div>
                {/* end flex */}
                <div>
                    <div className='mx-1'>
                        <p className='ml-[2%] text-white text-xl font-bold w-[55%]'>You won't be left alone</p>
                    </div>
